...
<main class="flex h-fit flex-col items-center gap-4 pt-24 pb-4">
	...
	<div class="w-[85%] md:w-[60%] space-y-5">
		<p class="text-justify font-poppins text-md md:text-xl">
			...
			you feel a particular way or seem to communicate specific messages? The psychology of colors
			goes beyond mere aesthetics, diving deep into the emotional and psychological effects that
			colors can have on individuals. In graphic design, understanding these effects is crucial to
		...
		<p class="text-justify font-poppins text-md md:text-xl">
			...
			orange, and purple. Taking it one level further, when you mix a primary with a secondary
			color, you get tertiary colors. These colors are named after their parent, yellow-orange,
		...
		<p class="text-justify font-poppins text-2xl">
			Here is an overview of color meanings for individual colors:
		</p>
		...
		<p class="text-justify font-poppins text-md md:text-xl">
			...
			to use it sparingly to make a powerful impact. If you frequently use red in your designs, it
			suggests that you are a passionate and energetic designer. You are not afraid to make bold
			statements and grab attention. Your designs are likely to be dynamic and full of life,
			reflecting your fearless approach and willingness to push boundaries.
		</p>
		...
		<p class="text-justify font-poppins text-md md:text-xl">
			...
			can be seen as more authoritative and serious. Designers who favor blue often convey a sense
			of calmness, reliability, and professionalism. You value stability and clarity, and your
			designs likely reflect these qualities. You strive to create trustworthy and dependable
			visuals, making you a go-to designer for corporate and professional projects.
		</p>
		...
		<p class="text-justify font-poppins text-md md:text-xl">
			...
			audience. Each color choice speaks volumes about who you are as a designer. By understanding
			the psychology of colors and how they reflect your unique characteristics, you can create
